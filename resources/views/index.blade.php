...
<div class="red">
    ...
    <div id="whatsaap">
        <a href="https://wa.me/593983979945?text=Hola+interesad%40+en+sus+Productos%3A+Helados Andinos y Tropicales" target="none" class="fab fa-whatsapp"></a>
    </div>
    <div id="linkeding">
...
@section('navbar')
    ...
    <a href="{{ url('/login')}}" class="logo">
        <h2 style="color: white" class="imgtamaño">MELANIC</h2>
                {{-- <img  class="imgtamaño " src="{{ asset('img/logo1.png')}}" alt="Helados Melanic" > --}}
    </a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="hero-text">
						...
						<br>
						<br>
                        {{-- <h1 class="tipeo1">MELANIC</h1> --}}
                        {{-- <h1 class="tipeo2"><span class="type"></span></h1> --}}
                        <span><h1></h1></span>
                        <span></span>
                        <span></span>
                        <div class="botonesinfo" style="margin-top: 43%">
                ...
                <div id="contenedor" class="row_p">
                    ...
                    <div id="verde" class="content_pagos"> 
                        ...
                        <button type="button" class="btnwssp btn btn-outline-success btn-lg">
                            <a target="none" href="https://wa.me/593983979945?text=Hola%2CEstoy+interesad%40+en+la+oferta%3A+{{$oferta->titulo}}">
                               Preguntar
                            </a>
                        </button> 
                    </div>
