...
<main class="container_product">
    ...
    <div class="product-price">
        <span>S/{{$producto->price}}</span>
            <a target="none" href="https://wa.me/593983979945?text=Hola+interesad%40+en+el+Producto%3A+{{$producto->name}}" class="cart-btn">
            Consultar
            </a>
    </div>
  </div>
...
<footer class="footer">
    <div class="l-footer">
        ...
        <div class="b-footer">
            <p>Todos los Derechos reservados by <a href="" target="_blank">©DESTROY-KDD</a></p>
        </div>
</footer>
@endsection