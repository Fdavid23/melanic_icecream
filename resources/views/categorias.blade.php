...
<div class="main">
    ...
    <ul class="cards">
      ...
      <li class="cards_item">
        <div class="card">
          <div class="card_image"><img  src="{{ asset('img/salcedo4.jpeg')}}" height="100"></div>
...
<footer class="footer">
    ...
    <p>SOMO UNA EMPRESA DE ELABORACION Y EXORTACION DE HELADOS AL POR MAYOR Y MENOR LLEVANDO UNA EXELENTE CALIDAD AL CONSUMIDOR.
        ...
        <div class="b-footer">
            <p>Todos los Derechos reservados by <a href="https://josediazmirano.github.io/jldiaz/" target="_blank">Destroy</a></p>
        </div>
</footer>
@endsection