...
<head>
    ...
    <title>Melanic/Administrativo</title>
    <!-- Scripts -->
    ...
    <div id="app">
        <div class="wrapper">
            ...
            <aside class="main-sidebar bg-light elevation-4">
                <!-- Brand Logo -->
                <a  class="brand-link">
                    <img src="{{ asset('img/logo1.png') }}" alt="Helados-Melanic" class="brand-image img-circle"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">Melanic-IceCream</span>
                </a>
